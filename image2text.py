...
class Task:
    ...
    Attributes:
        Status (str): Текущий статус задачи ('Unknown',
        'Queued', 'InProgress', 'Completed').
        Id (str): Уникальный идентификатор задачи.
        DownloadUrl (str): URL для скачивания результатов
    ...
    def is_active(self):
        ...
        Returns:
            bool: True если задача еще выполняется, False если
            завершена или не начата.
        """
